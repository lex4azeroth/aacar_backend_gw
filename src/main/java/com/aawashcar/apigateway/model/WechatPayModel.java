...
public class WechatPayModel {
	...
	public void sign(PasswordEncoder encoder) {
		...
		stringBuilder.append("&key=").append(WechatConfig.getKey());
		this.sign = encoder.encode(stringBuilder.toString());
	}

	@Override
	public String toString() {
		return "<xml>" + "<appid><![CDATA[" + appid + "]]></appid>" + "<body><![CDATA[" + body + "]]></body>"
				+ "<mch_id><![CDATA[" + mch_id + "]]></mch_id>" + "<nonce_str><![CDATA[" + nonce_str + "]]></nonce_str>"
				+ "<notify_url><![CDATA[" + notify_url + "]]></notify_url>" + "<openid><![CDATA[" + openid
				+ "]]></openid>" + "<out_trade_no><![CDATA[" + out_trade_no + "]]></out_trade_no>"
				+ "<spbill_create_ip><![CDATA[" + spbill_create_ip + "]]></spbill_create_ip>" + "<trade_type><![CDATA["
				+ trade_type + "]]></trade_type>" + "<total_fee><![CDATA[" + total_fee + "]]></total_fee>"
